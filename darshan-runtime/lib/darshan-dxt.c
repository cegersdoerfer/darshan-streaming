        ...
        int64_t length, double start_time, double end_time)
{
    ...
    sprintf(jb11,"{\"id\":%ld \"start\":%ld \"end\":%ld \"tspec_start\":%0.6f \"tspec_end\":%0.6f \"length\":%ld \"offset\":%ld \"type\": %s}", rec_id, start_time, end_time, tspec_start, tspec_end, length, offset, "stat");
